...
enum ItemType
{
    ...
    IT_WEAPON_LOWEST = IT_WEAPON_TRACTOR,
    IT_WEAPON_HIGHEST = IT_WEAPON_MISSILE_LAUNCHER,
    IT_WEAPON_COUNT = IT_WEAPON_HIGHEST - IT_WEAPON_LOWEST + 1,

    IT_PRIMARY_WEAPON_LOWEST = IT_WEAPON_PEA_SHOOTER,
    IT_PRIMARY_WEAPON_HIGHEST = IT_WEAPON_MISSILE_LAUNCHER,
    IT_PRIMARY_WEAPON_COUNT = IT_PRIMARY_WEAPON_HIGHEST - IT_PRIMARY_WEAPON_LOWEST + 1,
