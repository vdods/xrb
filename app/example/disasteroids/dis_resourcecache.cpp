...
ResourceCache::ResourceCache ()
{
    ...
    RESOURCE_GLTEXTURE_INITIALIZATION(devourment_small)
    ...
    RESOURCE_GLTEXTURE_INITIALIZATION(grinder_small)
    RESOURCE_GLTEXTURE_INITIALIZATION(interloper_small)
    ...
    RESOURCE_GLTEXTURE_INITIALIZATION(revulsion_small)
    RESOURCE_GLTEXTURE_INITIALIZATION(sadface_small)
    RESOURCE_GLTEXTURE_INITIALIZATION(shade_small)
