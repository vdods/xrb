...
private:
    ...
    RESOURCE_GLTEXTURE_DECLARATION(devourment_small)
    ...
    RESOURCE_GLTEXTURE_DECLARATION(grinder_small)
    RESOURCE_GLTEXTURE_DECLARATION(interloper_small)
    ...
    RESOURCE_GLTEXTURE_DECLARATION(revulsion_small)
    RESOURCE_GLTEXTURE_DECLARATION(sadface_small)
    RESOURCE_GLTEXTURE_DECLARATION(shade_small)
