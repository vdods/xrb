...
Float const Revulsion::ms_scale_factor[ENEMY_LEVEL_COUNT] = { 11.0f, 11.5f, 12.5f, 15.0f };
...
Float const Revulsion::ms_weapon_impact_damage[ENEMY_LEVEL_COUNT] = { 10.0f, 12.0f, 15.0f, 20.0f };
