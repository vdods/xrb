// ///////////////////////////////////////////////////////////////////////////
// xrb_input_events.h by Victor Dods, created 2005/11/06
// ///////////////////////////////////////////////////////////////////////////
...
#if !defined(_XRB_INPUT_EVENTS_H_)
#define _XRB_INPUT_EVENTS_H_
...
public:
    ...
    /** @brief Returns the mouse's position delta generated by this event.
      */
    inline ScreenCoordVector2 const &GetDelta () const { return m_delta; }
...
#endif // !defined(_XRB_INPUT_EVENTS_H_)
