...
//    m_keycode_map[Key::PLUS] = Key::Create(Key::PLUS, "PLUS");
    ...
    m_keycode_map[Key::SLASH] = Key::Create(Key::SLASH, "SLASH");
...
//    m_keycode_map[Key::UNDERSCORE] = Key::Create(Key::UNDERSCORE, "UNDERSCORE");
    ...
    m_keycode_map[Key::LCTRL] = Key::Create(Key::LCTRL, "LCTRL");
    m_keycode_map[Key::RALT] = Key::Create(Key::RALT, "RALT");
    m_keycode_map[Key::LALT] = Key::Create(Key::LALT, "LALT");
    m_keycode_map[Key::RMETA] = Key::Create(Key::RMETA, "RMETA");
    m_keycode_map[Key::LMETA] = Key::Create(Key::LMETA, "LMETA");
    m_keycode_map[Key::LWINBLOWS] = Key::Create(Key::LWINBLOWS, "LWINBLOWS");
    m_keycode_map[Key::RWINBLOWS] = Key::Create(Key::RWINBLOWS, "RWINBLOWS");
