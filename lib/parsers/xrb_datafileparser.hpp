...
// xrb_datafileparser.hpp generated by trison at Sun Nov  8 21:26:42 2009
// from xrb_datafileparser.trison using trison.cpp.targetspec and trison.cpp.header.codespec
// DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY
...
#line 18 "xrb_datafileparser.trison"

#if !defined(_XRB_DATAFILEPARSER_HPP_)
#define _XRB_DATAFILEPARSER_HPP_
...
#line 106 "xrb_datafileparser.hpp"

/** A parser class generated by trison at Sun Nov  8 21:26:42 2009
  * from xrb_datafileparser.trison using trison.cpp.targetspec and trison.cpp.header.codespec.
  *
  * The term "primary source" will be used to refer to the .trison source file from which
  * this file was generated.  Specifically, the primary source is xrb_datafileparser.trison.
  *
...
public:
    ...
    }; // end of enum DataFileParser::ParserReturnCode

    /// "Namespace" for DataFileParser::Terminal::Name, which enumerates all valid
    /// token ids which this parser will accept as lookaheads.
    struct Terminal
    {
        /** There are two special terminals: END_ and ERROR_.
          *
          * DataFileParser::Terminal::END_ should be returned in %target.cpp.scan_actions
          * by the client when the input source has reached the end of input.  The parser
          * will not request any more input after DataFileParser::Terminal::END_ is received.
          *
          * DataFileParser::Terminal::ERROR_ should not ever be used by the client, as
        ...
        enum Name
        {
            ...
            STRING_FRAGMENT = 264,
            IDENTIFIER = 265
        }; // end of enum DataFileParser::Terminal::Name
    }; // end of struct DataFileParser::Terminal

    /// "Namespace" for DataFileParser::ParseNonterminal::Name, which enumerates
    ...
    struct ParseNonterminal
    {
        ...
        enum Name
        {
            ...
            /// directive).
            default_ = data_file
        }; // end of enum DataFileParser::ParseNonterminal::Name
    }; // end of struct DataFileParser::ParseNonterminal

    /** The client should package-up and return a DataFileParser::Token from
...
#line 36 "xrb_datafileparser.trison"
    ...
    DataFileStructure *AcceptedStructure () const
    {
        return DStaticCast<DataFileStructure *>(m_accepted_value);
    }
    DataFileStructure *StealAcceptedStructure ()
    {
...
private:
    ...
    DataFileValue *m_accepted_value;

#line 312 "xrb_datafileparser.hpp"
...
private:
    ...
    /** The %target.cpp.parse_method_access directive can be used to specify the
      ...
      * @return DataFileParser::PRC_SUCCESS if the parse was successful (which includes
      *         occurrences of parse errors which were handled by client-specified
      *         %error-accepting rules), or DataFileParser::PRC_UNHANDLED_PARSE_ERROR
      ...
      */
    ParserReturnCode Parse (DataFileValue * *return_token, ParseNonterminal::Name nonterminal_to_parse = ParseNonterminal::data_file);
    ...
    struct Nonterminal_
    {
        enum Name
        {
            ...
            value = 272,
            string = 273
        }; // end of enum DataFileParser::Nonterminal_::Name
    }; // end of struct DataFileParser::Nonterminal_
    struct Transition_;
    ...
    struct StackElement_
    {
        ...
        { }
    }; // end of struct DataFileParser::StackElement_

    typedef std::deque<StackElement_> Stack_;
    typedef std::deque<Token> LookaheadQueue_;

    ParserReturnCode Parse_ (DataFileValue * *return_token, ParseNonterminal::Name nonterminal_to_parse);
    ...
    }; // end of struct DataFileParser::Rule_
    ...
    struct State_
    {
        ...
        char const *m_description;
    }; // end of struct DataFileParser::State_
    ...
    }; // end of struct DataFileParser::Transition_
    ...
    friend std::ostream &operator << (std::ostream &stream, DataFileParser::Token const &token);
...
#line 70 "xrb_datafileparser.trison"

} // end of namespace Xrb

#endif // !defined(_XRB_DATAFILEPARSER_HPP_)

#line 458 "xrb_datafileparser.hpp"
